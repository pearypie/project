...
class user_order_detail_onlyseeState extends State<user_order_detail_onlysee> {
  ...
  getriderdata() async {
    print('rider == ${rider}');
    await Art_Services()
        .getonlyRider(widget.order_responsible_person.toString())
        .then((datauser) => {
              setState(() {
                rider = datauser;
              }),
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          children: [
                            Text(
                                'วันที่ : ${DateFormat('วันที่ d เดือน MMMM ปี y', 'th').format(DateTime.parse('${widget.orderdate}'))}'),
                            SizedBox(height: 20),
                            Text(rider == null ||
                                    widget.order_responsible_person ==
                                        'ยังไม่มีคนรับผิดชอบ'
                                ? 'รับผิดชอบโดย : ยังไม่มีคนรับผิดชอบ'
                                : 'รับผิดชอบโดย : ${rider![0].rider_name}  ${rider![0].rider_surname}'),
                            SizedBox(height: 20),
                            ListView.builder(
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            Text(
                                'สั่งในวันที่ : ${DateFormat('วันที่ d เดือน MMMM ปี y', 'th').format(DateTime.parse('${widget.orderdate}'))}'),
                            SizedBox(height: 20),
                            Text(
                                                  ...
                                                  builder: (context) {
                                                    return AlertDialog(
                                                      title: const Text(
                                                          'ร้องขอการยกเลิก'),
                                                      content: const Text(
                                                          'ต้องการที่จะร้องขอการยกเลิกไหม?'),
                                                      actions: <Widget>[
                                                        ElevatedButton(
                                                          onPressed: () =>
                                                              Navigator.of(
